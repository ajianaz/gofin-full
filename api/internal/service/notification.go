...
func (s *NotificationService) Notify(ctx context.Context, userID uuid.UUID, channel, notifType, title, message string) error {
...
func (s *NotificationService) NotifySecurity(ctx context.Context, userID uuid.UUID, title, message string) error {
	return s.Notify(ctx, userID, "email", "security", title, message)
}

// NotifyLogin sends a login notification.
func (s *NotificationService) NotifyLogin(ctx context.Context, userID uuid.UUID) {
...
func (s *NotificationService) NotifyPasswordChange(ctx context.Context, userID uuid.UUID) {
...
func (s *NotificationService) NotifyWalletShared(ctx context.Context, userID uuid.UUID, walletName string) {
...
func (s *NotificationService) NotifyRoleChanged(ctx context.Context, userID uuid.UUID, walletName, newRole string) {
...
func (s *NotificationService) NotifyAccessRevoked(ctx context.Context, userID uuid.UUID, walletName string) {
